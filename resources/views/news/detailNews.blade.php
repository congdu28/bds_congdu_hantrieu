...
@section('content')
    ...
    <!-- Phần nội dung riêng của action  -->
        <form class="form-horizontal " action="{{route('route_BackEnd_news_updateNews',['id'=>request()->route('id')])}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <h1 style="text-align: center;" class="m-3">CẬP NHẬT TIN TỨC</h1>
                            <label for="ten_de_thi" class="col-md-3 col-sm-4 control-label">Danh Mục Tin Tức <span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="category_news" id="name" class="form-control" value="{{$objItem->category_news}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="title" id="name" class="form-control" value="{{$objItem->title}}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="ten_de_thi" class="col-md-3 col-sm-4 control-label">Nội dung <span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="content" id="name" class="form-control" value="{{$objItem->content}}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
