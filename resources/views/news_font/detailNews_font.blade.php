            ...
            <div class="mdc-card mt-5 p-5"> 
                <div class="row agent-wrapper">
                    <div class="col-xs-12 col-sm-6 col-md-4 p-3">
                        ...
                        style="max-width: 100%; height:100%; margin-bottom: 10px;" class="img-responsive"/>
                    </div>
                    
                    <div class="col-xs-12 col-sm-6 col-md-4 p-3">
                        <h2 class="fw-600">{{$objItem->category_news}}</h2>
                        ...
                        <p class="mt-3 text-muted ">{{$objItem->description}}</p>    
                        <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">{{$objItem->title}}</span></p>
                        <p class="row middle-xs"><i class="material-icons primary-color"></i><span class="mx-2 text-muted fw-500">{{$objItem->content}}</span></p>
                        <p class="row middle-xs"><i class="material-icons primary-color">call</i><span class="mx-2 text-muted fw-500">{{$objItem->description}}</span></p>
