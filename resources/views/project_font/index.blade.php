            ...
            <div class="row agents-wrapper">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                    <div class="mdc-card o-hidden">
                        <a href="{{route('route_BackEnd_project_font_detailProject_font',['id'=>$item->id])}}">
                            <img src="{{ $item->images?''.Storage::url($item->images):'imagesProject/1669919614_a-tb-nha-pho-dongnai-pic-Phuoc-5634-1765-1646535597.jpg' }}" class="d-block mw-100">
                        </a>
                        <div class="p-3">
                            <h2 class="fw-600">{{$item->project_name}}</h2> 
                            ...
                            <p class="row middle-xs"><span class="mx-2 text-muted fw-500">{{$item->address}}</span></p>
                            <p class="row middle-xs"><span class="mx-2 text-muted fw-500">{{$item->owner}}</span></p>
                            <p class="row middle-xs"><span class="mx-2 text-muted fw-500">{{$item->description}}</span></p>
                            <p class="row middle-xs"><span class="mx-2 text-muted fw-500">{{$item->status}} </span></p>
