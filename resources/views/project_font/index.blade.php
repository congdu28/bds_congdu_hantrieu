...
<main class="content-offset-to-top">
    <div class="header-image-wrapper">
        ...
        <div class="header-image-content">
            ...
            <p class="desc">NIỀM TIN TRAO TRỌN SỰ AN TÂM</p>
        </div>
    </div>
    <div class="px-3">
                ...
                @foreach ($list as $item)
                 ...
                 <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                    <div class="mdc-card o-hidden">
                        <a href="#">
                            <img src="{{ $item->images?''.Storage::url($item->images):'imagesProject/1669919614_a-tb-nha-pho-dongnai-pic-Phuoc-5634-1765-1646535597.jpg' }}" class="d-block mw-100" style="width:380px; height=237px">
                        </a>
                        <div class="p-3">
                            ...
                            <p class="mt-3 text-muted fw-500">{{$item->description}}</p>
