            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="form-group">
                        <input type="text" name="search_ten_nguoi_dung" class="form-control" placeholder="Tiêu đề " value="">
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-xs-12" style="text-align:center;">
                    <div class="form-group">
                        ...
                        <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                            Clear </a>
                        <a href="{{ route('route_BackEnd_banner_addBanner') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                            Add new</a>
                    </div>
                </div>
            </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{route('route_BackEnd_banner_detailBanner',['id'=>$items->id])}}" style="white-space:unset;text-align: justify;">
                                    {{$items -> banner_name}}
                                    <i class="fa fa-edit"></i></a>
                            </td>
                            <td class="text-center">{{$items -> links}} </td>
